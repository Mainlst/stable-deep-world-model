...
class Atari:
    ...
    def __init__(
        ...
        # Convert game name to gymnasium format (e.g., "breakout" -> "ALE/Breakout-v5")
        ...
        # Get action meanings for verification
        action_meanings = self._env.unwrapped.get_action_meanings()
        assert action_meanings[0] == "NOOP"
